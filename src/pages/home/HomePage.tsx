...
export function HomePage() {
  ...
  // Maps for icons related to service categories
...
{/* The main container needs to not strictly be #111111 if there's a cover image */}
<div className="flex-1 rounded-lg overflow-hidden relative flex items-center p-8 md:p-12" style={{
  backgroundColor: heroSlides[currentSlideIndex]?.cover_image_url ? 'transparent' : '#111111'
}}>
  {heroSlides[currentSlideIndex]?.cover_image_url && (
    <div className="absolute inset-0 -z-10">
      <img 
        src={heroSlides[currentSlideIndex].cover_image_url} 
  ...
  <section className="mb-16">
    <div className="relative rounded-2xl overflow-hidden min-h-[400px] flex items-center justify-center">
      ...
      <div className="relative z-10 text-center px-4 max-w-2xl mx-auto py-16">
        <div className="text-accent font-bold tracking-widest uppercase mb-4 text-sm">{promoBanners[2].subtitle}</div>
        <h2 className="text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight whitespace-pre-line">
           {promoBanners[2].title.replace(/\\n/g, '\n')}
        </h2>
        <p className="text-gray-300 mb-8 text-lg">
          {promoBanners[2].subtitle}
        </p>
        {promoBanners[2].button_text && (
           <Link to={promoBanners[2].button_link || '#'} className="px-10 py-4 bg-accent text-white font-bold rounded-full shadow-xl hover:-translate-y-0.5 hover:shadow-2xl transition-all inline-block">
              {promoBanners[2].button_text}
           </Link>
        )}
      </div>
  ...
  <section className="mb-16">
    <div className="relative rounded-2xl overflow-hidden min-h-[400px] flex items-center justify-center">
      ...
      {/* 4. CENTER BANNER */}
      <section className="mb-16 rounded-[2rem] p-12 text-center flex flex-col items-center justify-center relative overflow-hidden min-h-[400px]"> 
         <div className="absolute inset-0 z-0">
            <img 
               src={promoBanners.length >= 3 ? promoBanners[2].image_url : "https://images.unsplash.com/photo-1441986300917-64674bd600d8?auto=format&fit=crop&q=80"} 
         ...
         <div className="relative z-10 text-white">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold mb-4 tracking-tight whitespace-pre-line">
              {promoBanners.length >= 3 ? promoBanners[2].title.replace('\n', '\n') : 'Découvrez Notre Nouvelle\nCollection'}
            </h2>
            <p className="text-white/80 font-medium mb-8 max-w-xl mx-auto md:text-lg leading-relaxed">
              {promoBanners.length >= 3 ? promoBanners[2].subtitle : 'Préparez-vous pour la saison avec nos dernières arrivées conçues pour apporter confort et style directement chez vous.'}
            </p>
            {promoBanners.length >= 3 ? (
              ...
              <button className="px-10 py-4 bg-accent text-white font-bold rounded-full shadow-xl hover:-translate-y-0.5 hover:shadow-2xl transition-all">
  ...
  <section className="mb-16">
    <div className="relative rounded-2xl overflow-hidden min-h-[400px] flex items-center justify-center">
      ...
      {/* 6. MOST RATED SERVICES SECTION */}
      <section className="mb-16 bg-surface p-8 rounded-2xl border border-border-light">
        <div className="flex items-center justify-between mb-8">
           <div>
             <h2 className="text-2xl font-bold text-text mb-1">Services les Mieux Notés</h2>
